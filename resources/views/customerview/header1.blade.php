        ...
        <div class="container">
            <div class="logo">
                <h1 itemprop="headline">
                    <a href="index-2.html" title="Home" itemprop="url"><img src="../{{'assets/'}}assets/images/logo2.png" alt="logo.png" itemprop="image">
                    </a></h1></div>
            <nav>
                <div class="menu-sec">
                    <ul>
                        <li class="menu-item-has-children"><a href="/home" title="HOMEPAGES" itemprop="url"><span class="red-clr">FOOD ORDERING</span>HOMEPAGES</a>

                        </li>
                        <li class="menu-item-has-children"><a href="#" title="RESTAURANTS" itemprop="url"><span class="red-clr">REAL FOOD</span>Our Food & Items</a>
                        <ul class="sub-dropdown">
                            <li><a href="/foodview" title="Food Preview" itemprop="url">Our Food Preview</a></li>

                            <li><a href="/itemview" title="Product Preview" itemprop="url">Our Product Preview</a></li>
                            <li><a href="our-services.html" title="RESTAURANT Services" itemprop="url">OUR SERVICES</a></li>
                        </ul>
                        </li>
                        <li class="menu-item-has-children"><a href="#" title="RESTAURANTS" itemprop="url"><span class="red-clr">Sea Resource BD</span>Blogs</a>
                            <ul class="sub-dropdown">
                                <li><a href="/foodblog" title="Food Preview" itemprop="url"> Food Blogs</a></li>

                                <li><a href="/itemsblog" title="Product Preview" itemprop="url">Items Blogs</a></li>
                            </ul>
                        </li>


                        <li class="menu-item-has-children"><a href="#" title="PAGES" itemprop="url"><span class="red-clr">Sea Resource BD</span>Galary</a>
                            <ul class="sub-dropdown">
                                <li><a href="foodview.blade.php" title="Food Preview" itemprop="url">Food Galary</a></li>

                                <li><a href="foodview.blade.php" title="Product Preview" itemprop="url">Item Galary </li>
                            </ul>

                        <li><a href="/contact" title="CONTACT US" itemprop="url"><span class="red-clr">REAL FOOD</span>CONTACT US</a></li>
                    </ul>
                </div>
            </nav><!-- Navigation -->
        </div>
...
<div class="responsive-header">
    ...
    <div class="responsive-logomenu">
        <div class="logo"><h1 itemprop="headline"><a href="index-2.html" title="Home" itemprop="url"><img src="{{'assets/'}}assets/images/logo.png" alt="logo.png" itemprop="image"></a></h1></div>
            ...
            <ul>
                ...
                <li class="menu-item-has-children"><a href="#" title="RESTAURANTS" itemprop="url"><span class="yellow-clr">REAL FOOD</span>RESTAURANTS</a>
                    <ul class="sub-dropdown">
                        ...
                        <li><a href="foodview.blade.php" title="RESTAURANT DETAILS" itemprop="url">OUR MENU</a></li>
                ...
                <li class="menu-item-has-children"><a href="#" title="PAGES" itemprop="url"><span class="yellow-clr">REAL FOOD</span>PAGES</a>
                    <ul class="sub-dropdown">
                            ...
                            <ul class="sub-dropdown">
                                <li class="menu-item-has-children"><a href="#" title="BLOG LAYOUTS" itemprop="url">BLOG LAYOUTS</a>
                                    <ul class="sub-dropdown">
                                        ...
                                        <li><a href="foodblog.blade.php" title="BLOG WITH LEFT SIDEBAR" itemprop="url">BLOG (W.L.S)</a></li>
                                ...
                                <li class="menu-item-has-children"><a href="#" title="BLOG DETAIL" itemprop="url">BLOG DETAIL</a>
                                    <ul class="sub-dropdown">
                                        ...
                                        <li><a href="blog-left.blade.php" title="BLOG DETAIL WITH LEFT SIDEBAR" itemprop="url">BLOG DETAIL (W.L.S)</a></li>
                                        <li><a href="blogview.blade.php" title="BLOG DETAIL WITH NO SIDEBAR" itemprop="url">BLOG DETAIL</a></li>
                                    </ul>
                                </li>
                        ...
                        <li class="menu-item-has-children"><a href="#" title="GALLERY" itemprop="url">GALLERY</a>
                            <ul class="sub-dropdown">
                                <li><a href="gallery.blade.php" title="FOOD GALLERY" itemprop="url">FOOD GALLERY</a></li>
                        ...
                        <li><a href="food-detail.blade.php" title="FOOD DETAIL" itemprop="url">FOOD DETAIL</a></li>
                    </ul>
                </li>
                <li>
                    <a href="/contact" title="CONTACT US" itemprop="url"><span class="yellow-clr">REAL FOOD</span>CONTACT US</a></li>
            </ul>
        </div>
        <div class="topbar-register">
            <a class="log-popup-btn" href="#" title="Login" itemprop="url">LOGIN</a> / <a class="sign-popup-btn" href="#" title="Register" itemprop="url">REGISTER</a>
