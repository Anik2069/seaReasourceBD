                                ...
                                <div class="card shadow">
                                    <div class="card-header bg-transparent border-0">
                                        <h2 style="text-align: center">
                                            <a href="/addclient">Add Dealers</a>
                                        </h2>                                    </div>

                                    <div class="card-header">
                                        <h2 class="mb-0">Dealers Info</h2>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="example2" class="table table-striped table-bordered w-100 text-nowrap">
                                                <thead>
                                                <tr>
                                                    <th class="wd-15p">Registered Date</th>
                                                    <th class="wd-15p">Name</th>
                                                    <th class="wd-15p">Phone</th>
                                                    <th class="wd-10p">Tags</th>
                                                    <th class="wd-25p">View</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                @foreach($value as $val)
                                                    <tr>
                                                        ...
                                                        <td>{{$val['phone']}}</td>
                                                        <td>{{$val['tags']}}</td>
                                                        <td><a href="/profile/{{$val['id']}}">View Profiles</a> </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
