                                ...
                                <div class="card-box card shadow">
                                    <div class="card-body border-bottom">
                                        <div class="clearfix"><hr>
                                            ...
                                            <p style="text-align: center">Dhaka,Bangladesh</p><hr>
                                            <div class="float-left">
                                                <h3 class="logo mb-0">MIS Report By Year</h3>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="float-left">
                                                        ...
                                                        <address>
                                                            <strong>{{$value['customername']}}</strong><br>
                                                            {{$value['address']}}
                                                            <br>
                                                    ...
                                                    <div class="float-right text-right">
                                                        ...
                                                        <address>
                                                            <strong>Sea Resource BD </strong><br>
                                                            A-91/3,Bank Colony
                                                            Savar,Dhaka 1203<br>
                                                            Phone::+678 586 9636
                                                        </address>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered m-t-30 text-nowrap">
                                                            ...
                                                            <tbody>
                                                            <tr>
                                                                <td>SEA_FOOD_{{$value['created_at']}}</td>
                                                                <td>{{$value['foodname']}}</td>
                                                                <td>{{$value['quantity']}}</td>
                                                                <td>{{$value['price']}}</td>
                                                                <td class="text-right">{{(double)$value['quantity']*(double)$value['price']}}</td>
                                                            </tr>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4">
                                                    <h4><br>
                                                        ...
                                                        <br> <br>
                                                        @if ($value['paymentmethod']=="Hand Cash")

                                                            Payment Status:  <h3 style="color:red">UnPaid</h3>
                                                        @endif
                                                        @if ($value['paymentmethod']=="Credit Card")
                                                            Payment Status:  <h3 style="color:green">Paid</h3>
                                                            Card No : {{$value['card']}}
                                                        @endif
                                                    </h4>
                                                    <hr>
                                                ...
                                                <div class="col-xl-4 col-12 offset-xl-8">
                                                    ...
                                                    <hr>
                                                    <h4 class="text-right text-xl">Garnd Total
                                                        : {{(double)$value['quantity']*(double)$value['price']}} <small>taka</small></h4>
                                                </div>
                                            </div>
                                            <hr>
